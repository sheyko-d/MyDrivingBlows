...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private static final int[] ATTRS = new int[]{
            ...
            android.R.attr.textColor, android.R.attr.paddingLeft,
    ...
    private float tabTextAlpha = 0.6f;
    private float tabTextSelectedAlpha = 1.0f;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        int paddingRight = a
                .getDimensionPixelSize(PADDING_RIGHT_INDEX, padding);
        a.recycle();
        ...
        tabTypefaceSelectedStyle = a.getInt(
                ...
                Typeface.BOLD);
        tabTextAlpha = a.getFloat(
                R.styleable.PagerSlidingTabStrip_pstsTextAlpha, HALF_TRANSP);
        tabTextSelectedAlpha = a.getFloat(
                R.styleable.PagerSlidingTabStrip_pstsTextSelectedAlpha, OPAQUE);
        a.recycle();
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        ...
        if (textView != null) {
            ...
            float alpha = pager.getCurrentItem() == position ? tabTextSelectedAlpha
                    : tabTextAlpha;
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTypeface(tabTypeface,
                        pager.getCurrentItem() == i ? tabTypefaceSelectedStyle
                                : tabTypefaceStyle);
    ...
    public void scrollToChild(int position, int offset) {
        ...
        if (position > 0 || offset > 0) {
            ...
            Log.d("Log", "page scrolled " + position + " = " + offset);
    ...
    private OnGlobalLayoutListener firstTabGlobalLayoutListener = new OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            ...
            if (scrollOffset == 0)
                scrollOffset = getWidth() / 2 - padding;
        }
    };
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Pair<Float, Float> lines = getIndicatorCoordinates();
        canvas.drawRect(lines.first + padding, height - indicatorHeight,
                lines.second + padding, height, rectPaint);
        // draw underline
        rectPaint.setColor(underlineColor);
        canvas.drawRect(padding, height - underlineHeight,
                tabsContainer.getWidth() + padding, height, rectPaint);
        // draw divider
        if (dividerWidth != 0) {
            dividerPaint.setStrokeWidth(dividerWidth);
